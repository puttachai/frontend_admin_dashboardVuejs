...
onMounted(async () => {
    ...
    try {
        ...
        const respone = await axios.get('http://localhost/api_admin_dashboard/get_dataEmployee.php')
    ...
    const updateEmployeeInList = async () => {
        const res = await axios.get('http://localhost/api_admin_dashboard/get_dataEmployee.php');
    ...
    const confirmDeleteEmployee = async (employee) => {
        ...
        if(result.isConfirmed){
            ...
            try {
                ...
                const response = await axios.post("http://localhost/api_admin_dashboard/Delete_Employee.php", {id: employee.id} );
